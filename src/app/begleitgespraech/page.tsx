    ...
    <>
      ...
      <section className="py-28 md:py-36">
        <div className="mx-auto max-w-4xl px-6 md:px-12">
          ...
          <p className="mt-10 max-w-2xl font-body text-lg font-normal leading-relaxed text-on-surface/60">
      ...
      <section className="bg-surface-container-low py-28 md:py-36">
        <div className="mx-auto max-w-2xl px-6 md:px-12">
          <div className="rounded-2xl border border-outline-variant/20 bg-surface-container-lowest px-8 py-14 text-center md:px-12 md:py-18">
            ...
            <p className="mt-2 font-label text-[0.8rem] font-normal text-on-surface/40">
              pro 60 Minuten
            </p>
            <Link
              href="#"
              className="group relative mt-12 inline-flex items-center justify-center overflow-hidden rounded-full bg-primary px-10 py-4 font-label text-[0.8rem] font-normal tracking-wide text-on-primary transition-all duration-300 hover:shadow-lg hover:shadow-primary/20"
            >
            ...
            <p className="mt-10 font-body text-[0.85rem] font-normal text-on-surface/40">
